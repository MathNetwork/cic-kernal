...
NerveKernel extends GenericKernel at \texttt{Key = UInt64} with three components: a Merkle-style content hash, a nerve-based storage format, and a decomposition function that converts expression trees into sets of nerves.  This section describes each component as implemented in the source.
